...
try
{
	...
	$result = SidabiPerfil::contarTodosRegistros();
	...
	$saida = null;
	if ($_search) {
		$result = SidabiPerfil::consultarTodosRegistros($sidx, $sord, $start, $limit, $filtro);
	}else{
		$result = SidabiPerfil::consultarTodosRegistros($sidx, $sord, $start, $limit);
	}
