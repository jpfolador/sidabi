...
try
{
    $retorno["results"] = BiodataEquipamento::procurarEquipamentoInline($gsSearchParam, $offset, $limit);
    $liTotalLinhas = BiodataEquipamento:: procurarEquipamentoInlineCount($gsSearchParam);
