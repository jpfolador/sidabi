...
try
{
	...
	$result = BiodataEquipamento::contarTodosRegistros();
	...
	$saida = null;
	if ($_search) {
		$result = BiodataEquipamento::consultarTodosRegistros($sidx, $sord, $start, $limit, $filtro);
	}else{
		$result = BiodataEquipamento::consultarTodosRegistros($sidx, $sord, $start, $limit);
	}
