...
try
{
    $retorno["results"] = BiodataProtocolo::procurarProtocoloInline($gsSearchParam, $offset, $limit);
    $liTotalLinhas = BiodataProtocolo:: procurarProtocoloInlineCount($gsSearchParam);
