...
try
{
    $retorno["results"] = BiodataGrupoEstudo::procurarGrupoEstudoInline($gsSearchParam, $offset, $limit);
    $liTotalLinhas = BiodataGrupoEstudo:: procurarGrupoEstudoInlineCount($gsSearchParam);
