...
try
{
	...
	$result = QuestionarioTipoAplicacao::contarTodosRegistros();
	...
	$saida = null;
	if ($_search) {
		$result = QuestionarioTipoAplicacao::consultarTodosRegistros($sidx, $sord, $start, $limit, $filtro);
	}else{
		$result = QuestionarioTipoAplicacao::consultarTodosRegistros($sidx, $sord, $start, $limit);
	}
