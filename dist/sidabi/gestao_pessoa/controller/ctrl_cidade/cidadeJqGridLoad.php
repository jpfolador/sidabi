...
$filtro["estado_nome"] 	= isset($_GET["estado_nome"]) ? $_GET["estado_nome"] : null;
...
try
{
	...
	$result = PublicCidade::contarTodosRegistros();
	...
	if ($_search) {
		$result = PublicCidade::consultarTodosRegistros($sidx, $sord, $start, $limit, $filtro);
	}else{
		$result = PublicCidade::consultarTodosRegistros($sidx, $sord, $start, $limit);
	}
	$saida["rows"] = $result;
