...
try
{
	...
	$result = PublicEstado::contarTodosRegistros();
	...
	if ($_search) {
		$result = PublicEstado::consultarTodosRegistros($sidx, $sord, $start, $limit, $filtro);
	}else{
		$result = PublicEstado::consultarTodosRegistros($sidx, $sord, $start, $limit);
	}
	$saida["rows"] = $result;
