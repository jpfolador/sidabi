...
try
{
	...
	$result = ParkinsonCategoria::contarTodosRegistros();
	...
	$saida = null;
	if ($_search) {
		$result = ParkinsonCategoria::consultarTodosRegistros($sidx, $sord, $start, $limit, $filtro);
	}else{
		$result = ParkinsonCategoria::consultarTodosRegistros($sidx, $sord, $start, $limit);
	}
